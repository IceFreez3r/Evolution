...
public:
  ...
  Dot(int energy, const unsigned int speed, const unsigned int sight, const std::pair<unsigned int, unsigned int> pos);
...
private:
  ...
  std::pair<unsigned int, unsigned int> position_; // position on the Testground
  ...
  std::pair<unsigned int, unsigned int> food_in_sight_pos_; // position of the food source in sight
};
